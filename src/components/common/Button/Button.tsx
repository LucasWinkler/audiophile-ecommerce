...
import { ReactNode, FC, HTMLAttributes, AnchorHTMLAttributes } from 'react';

// Extract the props for the HTML button element
type ButtonHTMLProps = Omit<HTMLAttributes<HTMLButtonElement>, 'type'>;

// Extract the props for the HTML anchor element
